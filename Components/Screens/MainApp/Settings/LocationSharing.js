...
const LocationSharing = ({ navigation }) => {
    ...
    const toggleSwitchLocationSharing = () => setIsLocationSharing(previousState => !previousState);
    const toggleSwitchLocationHistory = () => setIsLocationHistory(previousState => !previousState);
    ...
    return (
        <View style={{ backgroundColor: 'white', height: '100%' }}>
            ...
            <View style={{ borderBottomWidth: 1, borderColor: 'rgb(227, 227, 227)', paddingVertical: '3%', paddingHorizontal: '10%' }}>
                ...
                <Text style={{ color: "black", fontSize: 25, fontWeight: 'bold', marginTop: '20%' }}>Location Sharing</Text>
            ...
            <View style={{ borderBottomWidth: 1, borderColor: 'rgb(227, 227, 227)', paddingVertical: '3%', paddingHorizontal: '10%', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                ...
                <Text style={{ fontSize: 16, }}>Location Sharing Permissions</Text>
                <Switch
                    style={{}}
            ...
            <View style={{ borderBottomWidth: 1, borderColor: 'rgb(227, 227, 227)', paddingVertical: '3%', paddingHorizontal: '10%', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                ...
                <Text style={{ fontSize: 16, }}>Share Timeline (Location History)</Text>
                <Switch
                    style={{}}
                    trackColor={{ false: "rgb(224, 224, 234)", true: "rgb(61, 9, 162)" }}
